...
<html lang="en">
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <form action="" method="post">
                    ...
                    <a href="room.php" class="btn btn-success">Check Room Status</a>
                    <a href="admin_dashboard.php" class="btn btn-warning">View User Detail</a>
        ...
        <div class="row">
            <div class="col-md-12">
                <center><h2>Checked In User's Details</h2></center>
            </div>
            <br><br><br>
        </div>
        <div class="row">
            <div class="col-md-12">
                <center><h3>Single Non-Ac Rooms</h3></center>
            </div>
            <br>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <center><h3>Single Ac Rooms</h3></center>
            </div>
            <br>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <center><h3>Double Non-Ac Rooms</h3></center>
            </div>
            <br>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <center><h3>Double Ac Rooms</h3></center>
            </div>
            <br>
        </div>
        <div class="row">

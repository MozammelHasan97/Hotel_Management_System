...
<html lang="en">
    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-12">
                <center><h3>Filled Given Details</h3></center>
            </div>
        </div>
        <br><br>
                ...
                while ($row = mysqli_fetch_assoc($query_run)) {
                    ...
                    <div class="col-md-2" style="margin-left: 50px;">
                        <div class="card bg-light" style="width: 300px">
                            ...
                            <div class="card-body">
                                <p class="card-text">Room Status: <?php if($row['status'] == 0){echo "<b>Available</b>";}else{echo "<b>Booked</b>";} ?></p>
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <a href="unbook.php?rn=<?php echo $row['room_no']. "&rt=a" ;?>" class="btn btn-danger <?php if($row['status']==0){echo "disabled";}else{echo "active";} ?>">UnBook</a>
                            </div>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="col-md-2" style="margin-left: 50px;">
                        <div class="card bg-light" style="width: 300px">
                            ...
                            <div class="card-body">
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <a href="unbook.php?rn=<?php echo $row['room_no']. "&rt=a" ;?>?rn=<?php echo $row['room_no']. "&rt=b" ;?>" class="btn btn-danger <?php if($row['status']==0){echo "disabled";}else{echo "active";} ?>">UnBook</a>
                            </div>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="col-md-2" style="margin-left: 50px;">
                        <div class="card bg-light" style="width: 300px">
                            ...
                            <div class="card-body">
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <a href="unbook.php?rn=<?php echo $row['room_no']. "&rt=c" ;?>" class="btn btn-danger <?php if($row['status']==0){echo "disabled";}else{echo "active";} ?>">UnBook</a>
                            </div>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="col-md-2" style="margin-left: 50px;">
                        <div class="card bg-light" style="width: 300px">
                            ...
                            <div class="card-body">
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <a href="unbook.php?rn=<?php echo $row['room_no']. "&rt=d" ;?>" class="btn btn-danger <?php if($row['status']==0){echo "disabled";}else{echo "active";} ?>">UnBook</a>
                            </div>
                        </div>
                    </div>
                    <?php
